...
export default function AdminDashboard() {
  ...
  return (
    <>
      ...
      <WRAPPER className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
      ...
      <WRAPPER className="bg-card rounded-xl p-6 shadow-sm border border-border">
        <WRAPPER className="flex items-center gap-2 mb-6">
        ...
        {recentActivity.length > 0 ? (
          <WRAPPER className="space-y-4">
            {recentActivity.map((activity, index) => (
              ...
              >
                <WRAPPER className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center shrink-0">
                ...
                <WRAPPER className="text-xs text-muted-foreground shrink-0 text-right">
...
fs.writeFileSync(path.join(process.cwd(), 'app/page.tsx'), content);
