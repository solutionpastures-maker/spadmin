...
import { useCreateSmallGroup } from '@/lib/hooks/useSmallGroups';
...
export default function NewSmallGroupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Failed to create small group');
    }
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold text-foreground">Create New Small Group</h1>
            </div>
          </div>
        </div>
      </header>
