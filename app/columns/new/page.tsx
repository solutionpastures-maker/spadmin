...
import { useCreateColumnArticle } from '@/lib/hooks/useColumns';
import { FormField, FormSection, inputClass, slugify, textareaClass } from '@/components/cms/form-section';
import { ImagePicker } from '@/components/image-picker';

export default function NewColumnArticlePage() {
  const router = useRouter();
  const createMutation = useCreateColumnArticle();
      ...
      <header className="bg-card shadow-sm border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-16 gap-4">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-foreground">New Column Article</h1>
          </div>
        </div>
      </header>
