...
import { createSeries } from '../../../lib/supabase-client';
...
export default function NewSeriesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to episodes page to add episodes
      if (newSeries && newSeries.id) {
        router.push(`/series/${newSeries.id}/episodes`);
      } else {
        // Fallback: redirect to series list
        router.push('/series');
      }
    } catch (error) {
