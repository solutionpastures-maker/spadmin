...
import { useDevotionalById, useUpdateDevotional } from '@/lib/hooks/useDevotionals';
...
export default function EditDevotionalPage() {
  ...
  const updateMutation = useUpdateDevotional();
  ...
  useEffect(() => {
    if (devotional && !initialized) {
      const item = devotional as Devotional;
      setFormData({
        title: item.title,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold text-foreground">Edit Devotional</h1>
            </div>
          </div>
        </div>
      </header>
